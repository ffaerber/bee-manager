...
console.log(`wallet: ${plurToBzz(r.wallet!.bzzBalance).toFixed(2)} BZZ, ${(Number(r.wallet!.nativeTokenBalance) / 1e18).toFixed(2)} xDAI`);
console.log(`burn: ${r.burnPer30DaysBzz.toFixed(2)} BZZ/30d  ->  runway ${r.runwayDays.toFixed(0)} days\n`);
